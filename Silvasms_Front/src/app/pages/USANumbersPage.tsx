          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className="text-[#16C784] hover:text-[#0EA968] hover:bg-[#1B241D] text-xs sm:text-sm px-2 sm:px-3 py-1.5 sm:py-2 h-auto"
              >
        ...
        {selectedService && (
          <div className="bg-[#1B241D] border border-[#24352A] rounded-xl sm:rounded-2xl p-3.5 sm:p-5 shadow-xl">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-full bg-[#16C784]/20 flex items-center justify-center text-[#16C784] text-sm sm:text-lg font-bold border-2 border-[#16C784]">
                2
              </div>
              <h2 className="text-base sm:text-xl font-bold text-[#EAF2ED]">Review & Purchase</h2>
            </div>

            <div className="space-y-2.5 sm:space-y-3 mb-4 sm:mb-5">
              {/* Service Info */}
              <div className="bg-[#111713] border border-[#24352A] rounded-lg sm:rounded-xl p-2.5 sm:p-3">
                <p className="text-[10px] sm:text-xs text-[#6B8378] mb-0.5">Service</p>
                <p className="text-sm sm:text-base font-semibold text-[#EAF2ED]">{selectedService.name}</p>
              </div>

              {/* Country Info */}
              <div className="bg-[#111713] border border-[#24352A] rounded-lg sm:rounded-xl p-2.5 sm:p-3">
                <p className="text-[10px] sm:text-xs text-[#6B8378] mb-0.5">Country</p>
                <p className="text-sm sm:text-base font-semibold text-[#EAF2ED]">United States 🇺🇸</p>
              </div>

              {/* Price Display */}
              {isLoadingPrice ? (
                <div className="bg-[#111713] border border-[#24352A] rounded-lg sm:rounded-xl p-3 sm:p-4 flex items-center justify-center">
                ...
                <div className="bg-gradient-to-br from-[#16C784] to-[#0EA968] rounded-lg sm:rounded-xl p-3 sm:p-4">
                ...
                <div className="bg-[#111713] border border-[#EF4444]/30 rounded-lg sm:rounded-xl p-3 sm:p-4">

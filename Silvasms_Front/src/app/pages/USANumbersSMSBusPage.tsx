...
export default function USANumbersSMSBusPage() {
  ...
  const startPolling = () => {
    ...
    const poll = async () => {
      try {
        ...
        // success: false + error: "No SMS received yet" → keep polling silently
      } catch (error: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0A0F1E] via-[#0F1729] to-[#1E2A45] p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 p-6 rounded-2xl bg-gradient-to-r from-[#1D4ED8] via-[#1E40AF] to-[#0F2B6B] shadow-xl shadow-blue-500/20">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl sm:text-3xl text-white mb-2">USA Numbers</h1>
